...
{\color{Azul1FCQ} \epigraph{La LATIN-PGD c'est génial !}{Alexandre Daby-Seesaram}}

% Opcional: resumen de capítulo.
% \begin{chapabstract}
%     This is the chapter abstract. You can customize its style by modifying the environment \texttt{chapabstract} in the \texttt{cftesis.cls} file.
%     \lipsum[1]
% \end{chapabstract}
